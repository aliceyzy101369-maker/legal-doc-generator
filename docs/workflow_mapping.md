...
| 构建字段提取任务 §5.1 | `services.field_extraction_tasks` + `core.pipeline` | dry-run: `summary.field_extraction_tasks` (`mode_1` / `mode_23`); review: `summary.field_extraction_task_counts` only |
