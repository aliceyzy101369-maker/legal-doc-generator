...
| 字段提取任务 §5.1 | mode_1 / mode_23 列表 | dry-run：`field_extraction_tasks` + `source_preview`；review：`field_extraction_task_counts` | 部分 | `tests/test_field_extraction_tasks.py`；预览非默认全文 |
