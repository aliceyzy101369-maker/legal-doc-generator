...
- `FIELD_REFINE_MODE`、`LLM_FIELD_REFINE`、`FIELD_REFINE_TEXT_LIMIT`、`FIELD_REFINE_LLM_TIMEOUT`、`FIELD_REFINE_CHUNK_SIZE`、`FIELD_REFINE_MAX_CHUNKS`、`FIELD_REFINE_USE_CHUNKS`、`FIELD_REFINE_CHUNK_MAX_WORKERS`：精提 LLM 路径（第六至八阶段）
